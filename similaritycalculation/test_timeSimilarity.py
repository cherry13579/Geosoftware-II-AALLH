...
def test_timeLength():
    result1 = timeSimilarity.timeLength(['1956/01/01 00:00:00 GMT+0', '2088/01/01 00:00:00 GMT+0', 730.5], ['2015/12/04 15:28:59.122000 GMT+0', '2015/12/04 15:28:59.122000 GMT+0', 0])
    assert result1 == 0
    # 50years and 100 years
    result2 = timeSimilarity.timeLength(['1950/01/01 00:00:00 GMT+0', '2001/01/01 00:00:00 GMT+0', 730.5], ['2000/01/01 00:00:00 GMT+0', '2101/01/01 00:00:00 GMT+0', 0])
    assert result2 == 0.5
...
def test_NotSimilartime():
    result1 = timeSimilarity.timeLength(['1956/01/01 00:00:00 GMT+0', '2088/01/01 00:00:00 GMT+0', 730.5], ['1914/01/01 00:00:00 GMT+0', '1914/01/01 00:00:00 GMT+0', 123])
    result2 = timeSimilarity.timeOverlap(['1956/01/01 00:00:00 GMT+0', '2088/01/01 00:00:00 GMT+0', 730.5], ['2088/01/01 00:00:00 GMT+0', '2089/01/01 00:00:00 GMT+0', 123])
    ...
    # 50years and 100 years
    result4 = timeSimilarity.timeLength(['1950/01/01 00:00:00 GMT+0', '2001/01/01 00:00:00 GMT+0', 730.5], ['2000/01/01 00:00:00 GMT+0', '2101/01/01 00:00:00 GMT+0', 0])
    assert result1 == 0
    assert result2 == 0
    assert result3 == 0